...
if(isset($_GET["update"]))
{
  ...
  $content = "<form action='' method='post'>
    ...
    <fieldset>
        <legend>Update coffee object with id ".$_GET['update']."</legend>
        ...
        <textarea cols='70' rows='12' name='txtReview' value='$coffee->review' >
       </textarea>
...
else
{
   $content = "<form action='' method='post'>
    ...
    <fieldset>
        ...
        <label for='review'>Review: </label>
        <textarea cols='70' rows='12' name='txtReview'>
       </textarea>
